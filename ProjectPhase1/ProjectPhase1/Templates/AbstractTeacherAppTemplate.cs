...
namespace ProjectPhase1.Templates
{
    public abstract class AbstractTeacherAppTemplate
    {
        ...
        {
            Console.WriteLine("Welcome to Rainbow School Teacher's Management Portal");
            Console.WriteLine("What would you like to do?");
            Console.WriteLine("1) Load teachers from our  portal");
            Console.WriteLine("2) Save teachers in to our portal");
            Console.WriteLine("3) Add a teacher in to our portal");
            Console.WriteLine("4) Delete a teacher from our portal");
            Console.WriteLine("5) Update a teacher in to our portal");
            Console.WriteLine("6) Find teacher by ID");
            Console.WriteLine("7) List teachers from our portal");
            Console.WriteLine("8) Sort teachers from our portal");
